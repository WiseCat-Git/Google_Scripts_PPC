 ...
 *
 * Version: 1.0
 * Google AdWords Script on flopez
 *
 **/
...
var EMAIL_ADDRESSES = ["flopez.amm@gmail.com"];
...
function findKeywordsWithQSBelow(threshold) {
  var query = 'SELECT Id, AdGroupId, CampaignName, AdGroupName, Criteria, Criteria, QualityScore, Labels'
